...
public class TaxiDialogWin extends JFrame implements ActionListener,WindowListener,KeyListener
{
    ...
    private TaxiDialog myDialog;
    public JButton send;
    private String myName = "Your";
    private String otherName = "Client";

    public TaxiDialogWin(String header, TaxiDialog myDialog)
    {
        super(header);
