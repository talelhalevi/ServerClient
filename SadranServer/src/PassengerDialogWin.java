...
public class PassengerDialogWin extends JFrame implements ActionListener,WindowListener,KeyListener
{
    ...
    private PassengerDialog myDialog;
    public JButton send;
    private String myName = "Your";
    private String otherName = "Client";

    public PassengerDialogWin(String header, PassengerDialog myDialog)
    {
        super(header);
