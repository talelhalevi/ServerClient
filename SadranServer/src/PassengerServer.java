...
class PassengerServer extends Thread 	   //the parallel server
{
    ...
    public PassengerServer(Sadran sadran)   // constructor of a TCP server
    {
        try
        {
        	this.sadran=sadran;
    ...
    public void run()
    {
        try
        {
            while (true)
            {
                ...
                new PassengerDialog(clientSockets, this,sadran);
            }
