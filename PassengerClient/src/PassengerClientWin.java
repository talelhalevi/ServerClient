...
public class PassengerClientWin extends JFrame implements ActionListener,KeyListener
{
    ...
    private PassengerClient myClient;

    public PassengerClientWin(String header, PassengerClient myClient)
    {
        super(header);
	...
	@Override
	public void keyPressed(KeyEvent arg0)//this function is called when the client press on send 
	{
