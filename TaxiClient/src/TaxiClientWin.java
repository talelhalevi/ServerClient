...
public class TaxiClientWin extends JFrame implements ActionListener,KeyListener
{
    ...
    private TaxiClient myClient;

    public TaxiClientWin(String header, TaxiClient myClient)
    {
        super(header);
